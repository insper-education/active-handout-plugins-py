...
urlpatterns = [
    ...
    path("instructor/progress/weekly/<str:course_name>/<str:user_nickname>/<str:week>", views.student_weekly_data),
    path("instructor/progress/weekly/<str:course_name>/<str:week>", views.weekly_exercises)
